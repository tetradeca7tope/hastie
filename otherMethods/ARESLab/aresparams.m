...
useEndSpan, maxFinalFuncs, endSpanAdjust, newVarPenalty)
% aresparams
...
%                            maxFinalFuncs, endSpanAdjust, newVarPenalty)
%
...
if (nargin < 12) || isempty(endSpanAdjust) || (endSpanAdjust < 1)
    trainParams.endSpanAdjust = 1;
else
    trainParams.endSpanAdjust = endSpanAdjust;
end

if (nargin < 13) || isempty(newVarPenalty)
